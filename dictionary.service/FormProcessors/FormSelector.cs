...
namespace Dictionary.Service.FormProcessors
{
    internal static class FormSelector
    {
        ...
        //formy o danym rodzaju gramatycznym
        ...
        public static IEnumerable<Form> CondNonPast(this IEnumerable<Form> forms) => forms.Where(x => x.Categories.Contains("cond") && !x.Categories.Contains("praet") && !x.Categories.Contains("praet cond"));
        public static IEnumerable<Form> CondPast(this IEnumerable<Form> forms) => forms.Where(x => (x.Categories.Contains("praet cond")) || (x.Categories.Contains("cond") && x.Categories.Contains("praet")));
        ...
        public static IEnumerable<Form> Past(this IEnumerable<Form> forms) => forms.Where(x => x.Categories.Contains("praet") && !x.Categories.Contains("cond"));
